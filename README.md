# Política de Privacidade – RotinaFit

Repositório que hospeda a **Política de Privacidade** do aplicativo **RotinaFit** (iOS e Android).

## Conteúdo

- **[index.html](index.html)** – Versão em HTML da política de privacidade (recomendada para link nas lojas e no app).
